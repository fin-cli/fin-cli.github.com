...
FP-CLI also comes with a tab completion script for Bash and ZSH. Just download [fp-completion.bash](https://raw.githubusercontent.com/fp-cli/fp-cli/v2.12.0/utils/fp-completion.bash) and source it from `~/.bash_profile`:
